...
-- strided convolution implemented as stencil -> downsample -> conv
...
local stride = L.downsample(4, 4)(st)

local pad_size = { stride.type.w, stride.type.h }
...
local m = L.crop(0, 0, 0, 0)(remap(st_wt))
